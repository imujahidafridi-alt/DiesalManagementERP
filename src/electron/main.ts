...
handleIpc('transactions:updatePurchase', async (id: string, data, user: string, overrideValidation?: boolean) => TransactionService.updatePurchase(id, data, user, overrideValidation))
handleIpc('transactions:createSale', async (data, user: string) => TransactionService.createSale(data, user))
handleIpc('transactions:updateSale', async (id: string, data, user: string, overrideValidation?: boolean) => TransactionService.updateSale(id, data, user, overrideValidation))
handleIpc('transactions:createTransfer', async (data, user: string) => TransactionService.createTransfer(data, user))
handleIpc('transactions:updateTransfer', async (id: string, data, user: string, overrideValidation?: boolean) => TransactionService.updateTransfer(id, data, user, overrideValidation))
...
handleIpc('transactions:deleteTransaction', async (id: string, user: string, overrideValidation?: boolean) => TransactionService.deleteTransaction(id, user, overrideValidation))
